...
public class StressBarRenderer {
    private static final ResourceLocation ATLAS = new ResourceLocation("insanitymod", "textures/gui/stress_bar_atlas.png");
    ...
    public static void onRenderOverlay(RenderGuiOverlayEvent.Pre event) {
        ...
        float currentPanic = (float) player.getAttributeValue(PanicAttributes.PANIC.get());
